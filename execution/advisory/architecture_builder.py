...
_ENGINE_FLOWS = {
    "operations_engine": {
        ...
        "steps": [
            ...
            {"label": "Feed results to AI Control Tower", "type": "feedback", "icon": "bi-arrow-up-right"},
    ...
    "revenue_engine": {
        ...
        "steps": [
            ...
            {"label": "Feed insights to AI Control Tower", "type": "feedback", "icon": "bi-arrow-up-right"},
    ...
    "customer_engine": {
        ...
        "steps": [
            ...
            {"label": "Feed metrics to AI Control Tower", "type": "feedback", "icon": "bi-arrow-up-right"},

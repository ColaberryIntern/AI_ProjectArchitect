...
# reported in the heartbeat. With per-bucket cursors (see cb-cursor PR),
# rotated-out buckets retain their cursor and catch up on the next tick
# they're scanned — no mentions permanently lost, just higher latency
# for cold buckets.
